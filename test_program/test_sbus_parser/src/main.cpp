...
void loop() {
  ...
  if (got_sbus_data){
    ...
    USBSerial.print(" ch3: ");
    USBSerial.print(sbus_ch[2]);
    USBSerial.print(" ch4: ");
    USBSerial.print(sbus_ch[3]);
    USBSerial.print(" ch5: ");
    USBSerial.print(sbus_ch[4]);
    USBSerial.print(" ch6: ");
    USBSerial.print(sbus_ch[5]);
    USBSerial.print(" ch7: ");
    USBSerial.print(sbus_ch[6]);
    USBSerial.print(" ch8: ");
    USBSerial.print(sbus_ch[7]);
    USBSerial.print(" ch9: ");
    USBSerial.print(sbus_ch[8]);
    USBSerial.print(" ch10: ");
    USBSerial.print(sbus_ch[9]);
    USBSerial.print(" lostframe: ");
    USBSerial.print(lost_frame);
    USBSerial.print(" failsafe: ");
    USBSerial.println(failsafe);
  }
